[![](https://ci.appveyor.com/api/projects/status/github/DennisGaida/chocolatey-packages?svg=true)](https://ci.appveyor.com/project/DennisGaida/chocolatey-packages)
[Update status](https://gist.github.com/DennisGaida/fd90446667b0deac773d9206c6981be1)
[![](http://transparent-favicon.info/favicon.ico)](#)
[chocolatey/DennisGaida](https://chocolatey.org/profiles/DennisGaida)
...
- Powershell 5+.
- [Chocolatey Automatic Package Updater Module](https://github.com/chocolatey-community/chocolatey-au) (community-maintained continuation of the archived majkinetor/au): `Install-Module au` or `cinst au`.
...
In a package directory run: `Test-Package`. This function can be used to start testing in [chocolatey-test-environment](https://github.com/chocolatey-community/chocolatey-test-environment) via `Vagrant` parameter or it can test packages locally.
...
* Fork [chocolatey-community/chocolatey-packages-template](https://github.com/chocolatey-community/chocolatey-packages-template) (the maintained continuation of majkinetor/au-packages-template). If needed, rename it to `au-packages`.
