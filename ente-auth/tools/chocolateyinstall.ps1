...
$url32 = 'https://github.com/ente/ente/releases/download/auth-v4.4.25/ente-auth-v4.4.25-installer.exe'
...
$packageArgs = @{
  ...
  checksum       = '22cc8809692310c45257af7ccfdb5c798a2f681f90daae165f53e5a2073fbbe6'
  checksumType   = 'sha256'
